        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                <a class="nav-item nav-link" href="{{ route('student.index') }}">Student list</a>
                <a class="nav-item nav-link border-start border-2" href="{{ route('student.create') }}">Create student</a>
                <a class="nav-item nav-link border-start border-2" href="{{ route('city.index') }}">Cities</a>
              </div>
            </div>
          </nav>
        @yield('content')
